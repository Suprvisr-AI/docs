...
<div className="gif-placeholder">
  ...
  <div className="gif-placeholder-title">AI Chat in action</div>
  <div className="gif-placeholder-label">GIF placeholder — full chat interaction</div>
</div>
...
<div className="gif-placeholder">
  <div className="gif-placeholder-icon">🎬</div>
  <div className="gif-placeholder-title">Dice / Example prompts</div>
  <div className="gif-placeholder-label">GIF placeholder — clicking dice and selecting a prompt</div>
</div>
...
<div className="gif-placeholder">
  <div className="gif-placeholder-icon">🎬</div>
  <div className="gif-placeholder-title">AI reasoning & observations</div>
  <div className="gif-placeholder-label">GIF placeholder — real-time thinking display</div>
</div>
