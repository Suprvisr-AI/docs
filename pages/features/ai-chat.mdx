---
title: AI Chat
description: Cumulus AI Chat — streaming responses, role-aware answers, model selection, reasoning controls, and example prompts.
---
...
See [Reasoning Verbosity](/features/reasoning-verbosity) for how to control whether that reasoning is shown in the chat.

---

## Follow-up questions

Cumulus can ask clarifying questions before answering when your request needs more context. This is enabled by default and can be toggled off per chat. See [Follow-Up Questions](/features/follow-up-questions) for full details.
...
- [Follow-Up Questions](/features/follow-up-questions) — how clarifying question cards work
- [Reasoning Verbosity](/features/reasoning-verbosity) — control how much reasoning the AI shows
